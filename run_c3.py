...
class c3Processor(DataProcessor):
    def __init__(self, data_dir):
        ...
        for sid in range(3):
            ...
            for subtask in ["d", "m"]:
                if sid == 2:
                    with open(self.data_dir + "/" + ["train.json", "dev.json", "test.json"][sid],
        ...
        if os.path.exists(cache_dir):
            ...
            for (i, d) in enumerate(data):
                ...
                for k in range(4):
                    ...
                    examples.append(InputExample(guid=data[i][6], text_a=text_a, text_b=text_b, label=label, text_c=text_c))
